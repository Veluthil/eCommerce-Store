    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regular_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 1999.99.'}}, help_text='Maximum 1999.99', max_digits=6, verbose_name='Regular price')),
                ('discount_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 1999.99.'}}, help_text='Maximum 1999.99', max_digits=6, verbose_name='Discount price')),
