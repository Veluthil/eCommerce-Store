...
class ProductType(models.Model):
    """ProductType Table provides a list of the different types of products that are for sale."""
...
class Product(models.Model):
    """The Product table contains all the product items."""
    ...
    description_detailed_additional = models.TextField(
        verbose_name=_("Additional description detailed"),
        help_text=_("Not Required"),
        blank=True
    )
    ...
    regular_price = models.DecimalField(
        ...
        error_messages={
            "name": {
                "max_length": _("The price must be between 0 and 1999.99."),
            },
        },
        max_digits=6,
        decimal_places=2,
