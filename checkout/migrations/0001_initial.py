    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_method', models.CharField(choices=[('IS', 'In Store'), ('SD', 'Standard Delivery'), ('ED', 'Express Delivery')], help_text='Required', max_length=255, verbose_name='delivery method')),
